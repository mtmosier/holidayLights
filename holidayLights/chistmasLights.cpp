...
ChistmasLights::ChistmasLights(Adafruit_WS2801* pixelObj, bool rtcActive)
...
ChistmasLights::~ChistmasLights()
{
}

void
ChistmasLights::spawnLights()
{
		...
		if (nextLightId != 255) {
			...
			switch (random(0, 3)) {
				case 0:
					...
					_pixels[nextLightId].setGreenBounds(0, 0);
